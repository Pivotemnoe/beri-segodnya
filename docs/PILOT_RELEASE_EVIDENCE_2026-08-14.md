...
- Gradle lockfile закрепляет 53 уникальные зависимости `releaseRuntimeClasspath`; verification metadata содержит 362 компонента, 631 артефакт и ровно 631 SHA-256. Trusted/ignored bypasses, SHA-1 и MD5 отсутствуют.
